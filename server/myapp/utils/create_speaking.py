...
def create_speaking_test(
    ...
    if type_exam == 'single':
        ...
        exam = conversationSpeakingTest(subject, ratio_type, num_questions, difficulty, max_length)
...
def conversationSpeakingTest(
    ...
    """
    Generate a conversation-based speaking test with named characters.
    ...
    try:
        # Extract JSON array from the response (same as singleSpeakingTest)
        import json
        import re
    ...
    # Return the conversation speaking test
    return {
