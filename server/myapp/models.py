...
class ListeningExam(db.Model):
    ...
    def __repr__(self):
        return f"ListeningExam('{self.user_id}', '{self.course_id}', '{self.date_posted}')"
...
class ListeningQuestion(db.Model):
    ...
    def __repr__(self):
        return f"ListeningQuestion('{self.listening_exam_id}', '{self.date_posted}')"
...
class ListeningOption(db.Model):
    ...
    def __repr__(self):
        return f"ListeningOption('{self.option}', '{self.date_posted}')"
...
class Comment(db.Model):
    ...
    def __repr__(self):
        return f"Comment('{self.user_id}', '{self.course_id}', '{self.date_posted}')"
...
class HistoryListeningExam(db.Model):
    ...
    def __repr__(self):
        return f"HistoryListeningExam('{self.user_id}', '{self.listening_exam_id}', '{self.date_posted}')"
...
class HistoryListening_Option(db.Model):
    ...
    def __repr__(self):
        return f"HistoryListening_Option('{self.history_listening_exam_id}', '{self.listening_option_id}', '{self.date_posted}')"
